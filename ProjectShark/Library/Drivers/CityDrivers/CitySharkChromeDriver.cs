...
namespace ProjectShark.Library.Drivers.CityDrivers{
    ...
    /// </summary>
    public class CitySharkChromeDriver : CitySharkDriver{
        /// <summary>
        ...
        public CitySharkChromeDriver(string driverPath, TimeSpan timeSpan, List<string> options = null) : base("chrome",
        ...
        /// <param name="options">passed options of web browser if it is set to null it takes default options of web browser</param>
        public CitySharkChromeDriver(string driverPath, TimeSpan timeSpan, CitySharkScrapper scrapper, string url,
